...
const SubmitImage = ({ show }) => {
  ...
  function fileUploadHandler() {
    ...
    reader.addEventListener(
      "load",
      function () {
        changeState({ showUploaded: true, img: reader.result, submit: false });
      },
      false
    );
...
>>>>>>> 40970a7478e74cb71fa99fc918333df3fdc63459
      ...
      >
        <div>
          {state.showUploaded ? (
            <UploadFile src={state.img} submit={state.submit} />
          ) : (
            <div>
              <body>
                <svg
