...
const SubmitImage = () => {
    return (
        <div style={{ backgroundColor: "beige"}}>
            <input type="button" value="X" class="closeButton" style={{ marginLeft: "610px", marginTop: "40px", marginBottom: "0px", backgroundColor: "transparent", borderRadius: "7px", borderColor: "black" }} ></input>
            <h1 style={{marginLeft: "60px", marginTop: "0px", marginRight: "300px", fontWeight: "normal" }}>Upload an image</h1>
            <pre style={{ marginLeft: "60px", marginTop: "40px", fontWeight: "lighter", fontFamily: "sans-serif" }}>Pick a food of your choosing, upload and submit {"\n"} for a list of similar dishes.</pre>
            <div style={{ borderRadius: "15px", border: "7px solid gray", marginLeft: "60px", marginRight: "300px" }}>
                <body>
                    <svg style={{marginTop:"20px"}} width="310" height="110" viewBox="0 0 120 110" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <pre style={{ marginLeft: "75px", fontFamily: "sans-serif" }}><b>Drop & Drag</b> a file here {"\n"}            or click...</pre>
            ...
            <input type="button" value="Submit" style={{ marginBottom: "30px", border: "none", marginLeft: "540px", fontSize: 17, borderRadius: "15px", backgroundColor: "salmon", padding: "5px 20px" }}></input>
